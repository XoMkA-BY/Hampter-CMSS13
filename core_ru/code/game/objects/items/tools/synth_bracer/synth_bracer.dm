/obj/item/clothing/gloves/synth
	...
	icon = 'core_ru/icons/obj/items/synth/bracer.dmi'
	icon_state = "bracer_default"
	item_icons = list(
		WEAR_HANDS = 'core_ru/icons/mob/humans/onmob/synth/bracer.dmi'
	)
...
/obj/item/clothing/gloves/synth/get_mob_overlay(mob/user_mob, slot, default_bodytype = "Default")
	...
	var/image/bracer_img = overlay_image('core_ru/icons/mob/humans/onmob/synth/bracer.dmi', get_icon_state(user_mob, slot), null, RESET_COLOR|NO_CLIENT_COLOR)
